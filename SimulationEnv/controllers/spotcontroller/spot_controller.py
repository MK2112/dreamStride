...
motors = [f_l_s_a_motor, f_l_s_r_motor, f_l_e_motor, f_r_s_a_motor, f_r_s_r_motor, f_r_e_motor, r_l_s_a_motor,
          r_l_s_r_motor, r_l_e_motor, r_r_s_a_motor, r_r_s_r_motor, r_r_e_motor]
...
try:
    ...
    with conn:
        ...
        while spot_robot.step(timestep) != -1:
            try:
                full_data = socket_in.recv(int.from_bytes(socket_in.recv(4), byteorder="big"))
            ...
            obs = {
                ...
                "reward": calculate_reward(gps.getValues(), time_taken) # xyz, timestep
            }
